%@+leo-ver=4-thin
%@+node:gcross.20090227161347.2:@thin talk.tex
%@@language latex

%@<< Preamble >>
%@+node:gcross.20090227161347.3:<< Preamble >>
...
%@+node:gcross.20090227161347.4:<< Title/Author Information >>
...
\date[SIAM CSE09]
{SIAM Conference on Computational Science and Engineering, 2009}
...
%@+others
%@+node:gcross.20090301204519.10:Title
\begin{frame}
  \titlepage
\end{frame}

%@-node:gcross.20090301204519.10:Title
%@+node:gcross.20090228211431.3:General Strategy
...
\end{frame} 
%@-node:gcross.20090228211431.3:General Strategy
%@+node:gcross.20090301204519.4:Dinosaur
...
\end{frame}
%@-node:gcross.20090301204519.4:Dinosaur
%@+node:gcross.20090301204519.11:Outline
\begin{frame}{Outline}
  \tableofcontents
...
%@-node:gcross.20090301204519.11:Outline
%@+node:gcross.20090227161347.5:Motivation
\section{Motivation}
%@+node:gcross.20090227161347.9:Classic Systems
\subsection{Classic Divide and Conquer}

\begin{frame}{A Classical System}
\begin{center}
\includegraphics<1>[height=3cm]{fluiddiagram-1.pdf}
\includegraphics<2->[height=3cm]{fluiddiagram-2.pdf}
\end{center}
...
\end{frame} 
%@-node:gcross.20090227161347.9:Classic Systems
%@+node:gcross.20090227161347.8:Quantum Systems
...
%@-node:gcross.20090227161347.8:Quantum Systems
%@-node:gcross.20090227161347.5:Motivation
%@+node:gcross.20090227161347.6:Application
\section{Application}

%@+node:gcross.20090227161347.10:Grand Objective
\subsection{Grand Objective}
%@+node:gcross.20090301204519.2:Crash Course in Quantum Mechanics
...
\end{frame}
%@-node:gcross.20090301204519.2:Crash Course in Quantum Mechanics
%@+node:gcross.20090301204519.3:Variational Approach
...
%@-node:gcross.20090301204519.3:Variational Approach
%@-node:gcross.20090227161347.10:Grand Objective
%@+node:gcross.20090301204519.5:Using ``Divide and Conquer''
\subsection{Using ``Divide and Conquer''}

%@+node:gcross.20090301204519.6:Efficiently computing R(\vec{S}), Part 1
...
%@-node:gcross.20090301204519.6:Efficiently computing R(\vec{S}), Part 1
%@+node:gcross.20090301204519.8:Efficiently computing R(\vec{S}), Part 2
...
%@-node:gcross.20090301204519.8:Efficiently computing R(\vec{S}), Part 2
%@+node:gcross.20090301204519.7:Efficiently varying a site
...
%@-node:gcross.20090301204519.7:Efficiently varying a site
%@+node:gcross.20090301204519.9:The Battle of Haldane-Shastry
...
%@-node:gcross.20090301204519.5:Using ``Divide and Conquer''
%@-node:gcross.20090227161347.6:Application
%@+node:gcross.20090227161347.7:Summary
\begin{frame}{Summary}
    \begin{itemize}
    ...
    References:  Search for "Crosswhite" on arxiv.org.
\end{frame}
%@-node:gcross.20090227161347.7:Summary
%@+node:gcross.20090301204519.12:Open Questions
